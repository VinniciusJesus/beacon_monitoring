...
class NotificationService(private val context: Context) {
    ...
    private fun getIcon(): Int {
        ...
        val appIconId = res.getIdentifier("ic_action_name", "mipmap", packageName)
    ...
    private fun getBackgroundMonitoringTitle(): String {
        ...
        return if (titleStringId != 0) res.getString(titleStringId) else "Detecção de emergências em andamento"
    }
